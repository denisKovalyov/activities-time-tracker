...
export const ActivitiesHeader = ({ activities }: { activities: ActivityExtended[] }) => {
  ...
  return (
    <div className="flex justify-between max-w-2xl mx-auto">
      <div className="flex justify-center items-center w-full py-1 px-4 rounded-l-full bg-secondary text-white font-bold truncate">
        {activities.length
      ...
      <div className="relative">
        <span className="absolute -left-2 box-content w-full h-full border-background px-2 rounded-full bg-background" />
        <Suspense>
          <AddActivityButton />
        </Suspense>
      </div>

      <div className="flex justify-center items-center w-full py-1 px-4 rounded-r-full bg-secondary text-white font-bold truncate">
        {activities.length
